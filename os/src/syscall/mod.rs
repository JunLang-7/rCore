...
pub fn syscall(syscall_id: usize, args: [usize; 4]) -> isize {
    match syscall_id {
        ...
        SYS_SEMAPHORE_CREATE => sys_semaphore_create(args[0]),
        SYS_SEMAPHORE_UP => sys_semaphore_up(args[0]),
        SYS_SEMAPHORE_DOWN => sys_semaphore_down(args[0]),
        SYS_CONDVAR_CREATE => sys_condvar_create(),
        SYS_CONDVAR_SIGNAL => sys_condvar_signal(args[0]),
        SYS_CONDVAR_WAIT => sys_condvar_wait(args[0], args[1]),
