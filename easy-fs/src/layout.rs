...
impl SuperBlock {
    ...
    /// Check whether the superblock is valid
...
impl DiskInode {
    /// Initialize a disk inode, as well as alll direct inodes under it.
    /// indirect1 and indirect2 are allocated only when needed
    pub fn initialize(&mut self, type_: DiskInodeType) {
        self.size = 0;
        self.direct.iter_mut().for_each(|d| *d = 0);
        self.indirect1 = 0;
        self.indirect2 = 0;
        self.type_ = type_;
    }
    ...
    /// Return block number corresponding to current size
    ...
    /// Return number of blocks needed included indirect blocks
    ...
    /// Get id of block given its inner id
    ...
    /// Increase size of current disk inode
    pub fn increase_size(
        ...
        // fill indirect2 blocks from (a0, b0) to (a1, b1)
        let mut a0 = current_blocks as usize / INODE_INDIRECT1_COUNT;
        let mut b0 = current_blocks as usize % INODE_INDIRECT1_COUNT;
        let a1 = total_blocks as usize / INODE_INDIRECT1_COUNT;
        let b1 = total_blocks as usize % INODE_INDIRECT1_COUNT;
        // alloc indirect1 blocks
    ...
    /// Write data to current disk inode
